...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; background: #10b981; color: #fff; padding: 3px 10px; border-radius: 10px; font-size: 11px; font-weight: bold; }
    </style>
</head>
<body>
    <div class="container">
        <div class="header">
            <h1>Bon de commande — {{ $order->getOrderNumber() }}</h1>
            ...
            <div class="info-box">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 4px 8px;"><span style="color: #888; font-size: 12px;">Statut</span><br><span class="badge">Signé</span></td>
                    </tr>
                </table>
            </div>

            <p style="font-size: 12px; color: #888;">Le bon de commande signé est joint à cet email en pièce jointe (PDF).</p>
        </div>

        <div class="footer">
            IUT de Villetaneuse — Université Sorbonne Paris Nord<br>
            Cet email a été envoyé automatiquement depuis le système de suivi des commandes.
        </div>
    </div>
</body>
</html>
